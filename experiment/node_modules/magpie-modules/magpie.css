...
/*Dennis: custom answer container, less margin*/
.magpie-view-answer-container-custom {
    text-align: center;
    margin: 10px auto;
}
/* Dennis: changed height to 'auto' from '350px'*/
...
/*Dennis: custom class*/
.magpie-response-sentence-custom {
    background: rgba(50, 77, 147, 0.05);
    border-radius: 5px;
    display: block;
    font-family: "Lato", "Noto Sans", sans-serif;
...
/*Dennis: custom hover state*/
.magpie-response-sentence-custom:hover {
    background: rgba(50, 77, 147, 0.15);
    cursor: pointer;
}
